...
- **[Price-history lookback](https://joehahn.github.io/portfolio-wave-rider/sweep_lookback.html)** — values `[0.5, 1, 1.5, 2, 3, 5]` years. Length of the window used to estimate `μ` and `Σ`. Default 2y.
