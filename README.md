...
Results are served via three families of GitHub Pages, each showing results that are generated by the same retriever+curator pipeline playing across three different slices of time.

**Backtest dashboards**: these dashboards show 3 years of historical outcomes from July 2023 to 2026:
...
**Bootstrap dashboards**: these dashboards apply the AI curator as the solution transitions from acting on the last 3 months of the historical backtest news, to that acquired daily since July 22, 2026:
...
**Forwardtest dashboards**: this playtests this solution on news ingested daily since 2026-07-22, with no reliance on the historical backtest news:
