...
Results are served via three families of GitHub Pages, each showing results generated by the same retriever+curator pipeline played across three different slices of time.
...
*Bootstrap:* apply the AI curator to news from final 3 months of the above backtest + news collected daily since 2026-07-22:
...
*Forwardtest:* playtests tthe go-live version of this solution on news daily since 2026-07-22:
