...
Results are served via three families of GitHub Pages, with each showing results that generated by the same retriever+curator pipeline playing across three different slices of time.
...
**Bootstrap dashboards**: these dashboards inspect outcomes as this solution focusses on the transition from using the last 3 months of the historical backtest news to news acquired daily since July 22, 2026:
...
- *[Curator Bootstrap (CBS)](https://joehahn.github.io/portfolio-wave-rider/curator_bootstrap.html)*: this visualizes the AI curator's outputs across the boostrap era and shows the portfolio recommendations and values over time
