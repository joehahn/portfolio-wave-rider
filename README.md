...
| Weekly, Fri 17:00 local | cron | Re-runs the mean-variance optimizer over the holdings universe, appends new target weights to `data/recommendations.csv`, then refreshes both dashboards. | `data/recommendations.csv`, `data/dashboard.html`, `docs/index.html` |
