...
- *[Forwardtest (FT)](https://joehahn.github.io/portfolio-wave-rider/forward_dashboard.html)*: visualize gains & losses that would be generated by this solution if it were used in real life

**Landing page**: [`docs/index.html`](https://joehahn.github.io/portfolio-wave-rider/) is the older live-portfolio page, showing per-ticker value, recommended weights, and the curation log off the same daily snapshot the FT dashboard reads. It will be merged into FT soon.
