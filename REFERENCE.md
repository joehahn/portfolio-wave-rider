...
1. *The result is fragile (n=1).* The curator trailed the equal-weight buy-and-hold for ~85% of the window and only pulled ahead in 2025, when the optimizer concentrated ~70% of the book in RKLB and RKLB ran. The +126pp lift rests on a single late position, so it cannot distinguish skill from luck.
