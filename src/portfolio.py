...
def build_curator_dashboard(
    ...
    try:
        ...
        if not _lr.empty:
            ...
            # Curation reports for THIS portfolio, linked from the dashboard. The .md lives in the
            # gitignored data/reports/; write_review_report also drops a browser-readable .html twin in
