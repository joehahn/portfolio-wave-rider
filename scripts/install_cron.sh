...
#
# To uninstall: run `crontab -e` and delete the two lines ending in news_pull.sh / price_snapshot.sh.
set -euo pipefail
...
echo "Uninstall: run 'crontab -e' and delete the news_pull.sh / price_snapshot.sh lines."
