...
SNAP_LINE=$'# PWR: Weekday price snapshot + dashboard + Curator Bootstrap refresh, Mon-Fri 16:30 local\n'"30 16 * * 1-5  $SNAP"
REVIEW_LINE=$'# PWR: Biweekly curation review + report (self-gated by rebalance_period), Mon-Fri 19:00 local\n'"0 19 * * 1-5  $REVIEW"
