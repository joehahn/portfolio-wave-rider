...
REC_MAX_DD, REC_MAX_L1, REC_MAX_L2 = 45.0, 800.0, 1000.0   # |maxDD|% , L1 turnover , L2 path-length ceilings
...
def build(runs_dir: str, out: Path, recompute: bool = False) -> None:
    ...
    nlb_html = (
        ...
        '21&rarr;28d boundary <b>conflates the news-window effect with the lede-mode change</b>, not a clean '
