...
| Adds executed | 22 |
| Removes executed | 8 |
| Final watchlist size | 17 |
| Rebalances (optimizer calls) | 21 |
| Mean L1 weight distance rebalance-to-rebalance | 0.5367 |

## Realized performance vs baselines

| Strategy | Ending value | Total return | Active vs curator |
|---|---|---|---|
| Curator-driven | $368,379.35 | +636.76% | — |
| Buy-and-hold starter (equal-weight, then hold) | $214,360.61 | +328.72% | +308.04pp |

## Risk and benchmarks

| Metric | Value |
|---|---|
| Annualized return (curator) | +49.06% |
| Max drawdown (curator) | -53.13% |
