...
**Cadence:** quarterly
**Optimizer:** `mean_variance`, lookback 2.0y, max_weight 0.50
...
| Mean L1 weight distance rebalance-to-rebalance | 0.4445 |

## Realized performance vs baselines

| Strategy | Ending value | Total return | Active vs curator |
|---|---|---|---|
| Curator-driven | $302,237.87 | +504.48% | — |
| Buy-and-hold starter (day-0 optimize, then hold) | $94,234.48 | +88.47% | +416.01pp |

## Risk and benchmarks

| Metric | Value |
|---|---|
| Annualized return (curator) | +43.28% |
| Max drawdown (curator) | -42.50% |
